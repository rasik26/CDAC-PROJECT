            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                        ...
                        <Disclosure.Panel className="pt-6">
                          ...
                          <RadioGroup
                            ...
                            {section.options.map((option, optionIdx) => (
                              ...
                              <>
                               <FormControlLabel onChange={(e)=>{handleSingleFilterChange(e,section.id)}} value={option.value} control={<Radio />} label={option.label} />
                              </>
              ...
              <div className="lg:col-span-4 w-full">
                <div className='flex flex-wrap justify-center bg-white py-4'>
                    {products.map((item)=> <ProductCard productt={item}/> )}
                </div>
              </div>
