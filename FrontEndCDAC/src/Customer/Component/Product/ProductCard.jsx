...
export default function ProductCard({productt}) {
    ...
    return (
        <div onClick={()=>navigate(`/art/${5}`)} className="productCard w-[15rem] m-3 transition-all cursor-pointer rounded-md shadow-lg overflow-hidden">
            ...
            <div className="textpart bg-white p-3">
                ...
                <div>
                    <p className="text-lg font-semibold text-gray-800">{productt.price}</p>
                </div>
            </div>
        </div>
    );
